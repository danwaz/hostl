...
#run `hostl` in the root of your project directory
#that's it!
...
#run `hostl open` to also open files in your editor of choice
OPEN_INPUT=$1
OPEN_KEY="open"
...
printf "\tErrorLog \"/private/var/log/apache2/$CURRENT_DIR-error_log\"\n" >> $VHOSTS_FILE
printf "</VirtualHost>\n" >> $VHOSTS_FILE
printf "\n" >> $VHOSTS_FILE
